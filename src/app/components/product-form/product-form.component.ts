...
export class ProductFormComponent implements OnInit, OnChanges {
  ...
  */
  ...
  @Output() teamToDelete = new EventEmitter<number>();

  deleteFormationByUserAndTeam(idUser: number, idTeam: number): void {
    this.idTeam = idTeam;
    this.toDelete = idUser;
    this.userToDelete.emit(this.toDelete);
    this.teamToDelete.emit(this.idTeam);
  }

  /*
    Get history of the product
  */
